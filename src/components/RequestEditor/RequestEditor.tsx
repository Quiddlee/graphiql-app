...
const RequestEditor: FC<HTMLAttributes<HTMLElement>> = ({ children, ...props }) => {
  ...
  return (
    <section
      ...
      className={cn(
        'animation-delay-200 transition-enter-screen relative row-start-1 row-end-2 flex h-full w-full origin-top animate-fade-in-screen gap-4 overflow-y-hidden rounded-4xl bg-surface-container pl-6',
      )}
    >
